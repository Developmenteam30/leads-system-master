<template>
    ...
    <AsyncPage>
        ...
        />
        <p class="mt-3">ST = Successful Transfers (ST/STSSDI) &bull; FT = Failed Transfers &bull; BT = Billable Transfers</p>
        <CustomDatatableAjax
            :ajax-url="`reports/agent-daily-stats`"
