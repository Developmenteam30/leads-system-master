<template>
    <AbstractList
        ajax-url="petty-cash-locations/manage"
        title-singular="Petty Cash Location"
        title-plural="Petty Cash Locations"
        :form="form"
    ...
    >
        ...
        <template v-slot:edit-modal>
            <MDBAlert v-if="form.id" color="warning" static class="mb-4"><i class="fas fa-exclamation-triangle me-3"></i> Changing this value will update the location for all Petty Cash entries
                already on file.
            </MDBAlert>

            <MDBInput label="Location" v-model="form.location" :maxlength=255 />
