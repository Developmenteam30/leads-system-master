...
class CallDetailLogUploadController extends BaseController
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->has('is_last') && $request->boolean('is_last')) {
                ...
                $upload->virusScan([
                    'Documentable Type' => 'Call Detail Log',
                ]);
                ...
                $log = AuditLog::createFromRequest($request, 'UPLOAD:DIALER-CALL-DETAIL-LOG', [
                    'file' => $newPath,
